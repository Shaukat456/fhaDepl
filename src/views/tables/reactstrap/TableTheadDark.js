...
import { ARBtn } from '../../components/buttons/ButtonsFilled'
...
const TableTheadDark2 = (props) => {
  

  //declare state here 
  //extract input component value 
...
const NoListItem=()=>{
 ...
 const addRow=(newConsumer)=>{

      setdata([...data,newConsumer])
    ...
    <Table responsive>
      ...
      <tbody>
        ...
        
        {
          ...
          <td>{e.key}  </td>
           <td>
             <Button.Ripple color='danger' onClick={()=>  DeleteRow(e.id)} > Delete Row </Button.Ripple>
      ...
      {nodata}
    <Button.Ripple color='primary'     > Add Row </Button.Ripple> 
